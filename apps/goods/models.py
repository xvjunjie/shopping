...
class GoodsCategory(models.Model):
    ...
    name = models.CharField(default="", max_length=30, verbose_name="类别名", help_text="类别名")  # help_text帮助生成文档
    ...
    parent_category = models.ForeignKey("self", null=True, blank=True, verbose_name="父类目级别", help_text="父目录",
                                        related_name="sub_cat", on_delete=models.CASCADE)  # 让自己指向自己这张表，注意"self"
